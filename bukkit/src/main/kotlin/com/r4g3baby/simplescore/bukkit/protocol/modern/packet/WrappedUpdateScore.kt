        ...
        init {
            try {
                val packetPlayOutScoreboardScore = Reflection.findClass(
                    ...
                    "${NMS}.PacketPlayOutScoreboardScore"
                )
                packetInstantiator = getInstantiatorOf(packetPlayOutScoreboardScore)
                ...
                if (ServerVersion.atOrAbove(ServerVersion("1.20.3"))) {
                    ...
                    val enumAction = Reflection.findClass(
                        ...
                        $$"net.minecraft.server.ScoreboardServer$Action", $$"$${NMS}.ScoreboardServer$Action"
                    )
