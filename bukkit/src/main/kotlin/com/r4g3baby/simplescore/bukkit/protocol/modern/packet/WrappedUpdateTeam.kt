...
import com.r4g3baby.simplescore.bukkit.util.getInstantiatorOf
    ...
    private companion object {
        ...
        init {
            try {
                ...
                packetInstantiator = getInstantiatorOf(packetPlayOutScoreboardTeam)
                ...
                if (ServerVersion.atOrAbove(ServerVersion.cavesAndCliffsPartIUpdate)) {
                    ...
                    val enumChatFormat = Reflection.getClass("${NMS}.EnumChatFormat")
        ...
        private companion object {
            ...
            init {
                try {
                    ...
                    classInstantiator = getInstantiatorOf(teamInfoClass)
